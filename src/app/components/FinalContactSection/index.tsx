...
export const FinalContactSection = ({ contactRef }: FinalContactSection) => {
    ...
    >
      <div className="container mx-auto text-center">
        ...
        <p className="text-lg mb-8">
          Junte-se a nós e descubra como podemos ajudar a levar sua empresa ao
          próximo nível.
        </p>
        <div className="container my-24 mx-auto md:px-6">
          <section className="mb-32">
            <div className="flex flex-wrap">
              ...
              <div className="mb-12 w-full rounded-2xl bg-gradient-to-r from-blue-500 to-teal-400 shrink-0 grow-0 basis-auto md:mb-0 md:w-6/12 md:px-3 lg:px-6 flex flex-col justify-center">
                {loading ? (
                  <Spinner />
                ) : (
                  <form
